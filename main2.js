...
const math = [
    ...
    '<math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><mn> 2 </mn><mo> + </mo><mrow><mn> 3 </mn><mo> &InvisibleTimes; </mo><mi> &ImaginaryI; </mi></mrow></mrow></math>',
    ...
    '<math xmlns="http://www.w3.org/1998/Math/MathML"><mfrac><mo> &DifferentialD; </mo><mrow><mo> &DifferentialD; </mo><mi> x </mi></mrow></mfrac></math>',
    '<math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><munder><mo> ( </mo><mo> &UnderBar; </mo></munder><mfrac><mi> a </mi><mi> b </mi></mfrac><mover><mo> ) </mo><mo> &OverBar; </mo></mover></mrow></math>',
    ...
    '<math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><mo> there exists </mo><mrow><mrow><mi> &delta; </mi><mo> &gt; </mo><mn> 0 </mn></mrow><mo> such that </mo><mrow><mrow><mi> f </mi><mo> &ApplyFunction; </mo><mrow><mo> ( </mo><mi> x </mi><mo> ) </mo></mrow></mrow><mo> &lt; </mo><mn> 1 </mn></mrow></mrow></mrow></math>',
    ...
    '<math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><msubsup><mo> &int; </mo><mn> 0 </mn><mn> 1 </mn></msubsup><mrow><msup><mi> &ExponentialE; </mi><mi> x </mi></msup><mo> &InvisibleTimes; </mo><mrow><mo> &DifferentialD; </mo><mi> x </mi></mrow></mrow></mrow></math>',
    ...
    '<math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><mover accent="true"><mi> x </mi><mo> &Hat; </mo></mover><mtext>&nbsp;versus&nbsp;</mtext><mover accent="false"><mi> x </mi><mo> &Hat; </mo></mover></mrow></math>',
    ...
    '<math xmlns="http://www.w3.org/1998/Math/MathML"><mrow><msubsup><mo>&int;</mo><mn>1</mn><mi>t</mi></msubsup><mfrac><mrow><mo>&dd;</mo><mi>x</mi></mrow><mi>x</mi></mfrac></mrow></math>',
    '<math><mrow><msubsup><mo> &int; </mo><mn> 0 </mn><mn> 1 </mn></msubsup><mrow><msup><mi> &ExponentialE; </mi><mi> x </mi></msup><mo> &InvisibleTimes; </mo><mrow><mo> &DifferentialD; </mo><mi> x </mi></mrow></mrow></mrow></math>'
]
...
const callMathCAT = (mathML) => {
    try {
        ...
        return JSON.parse( stdout.toString().replaceAll('"','\\"').replaceAll("'",'"').replace('clearspeak','"clearspeak"').replace('braille','"braille"').replace('version','"version"') )
    } catch(e) {
        console.log(e)
